...
#
FILE_DA_CONSEGNARE=intList.h threadpool.c queue.c connections.c parser.c membox.c message.h ops.h stats.h DATA/membox.conf1 DATA/membox.conf2
# inserire il nome del tarball: es. NinoBixioGiuseppeGaribaldi
TARNAME=DanDorinIzvoreanuFedericaCurrau
#
###########################################################
...
OBJECTS		=  connections.o icl_hash.o membox.o parser.o queue.o threadpool.o
